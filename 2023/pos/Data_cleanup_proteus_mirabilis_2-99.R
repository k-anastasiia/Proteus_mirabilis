...
Directory <- setwd('/home/anastasiia/Desktop/proteus mirabilis/new_method_pos_2-99_ALL/Data_cleanup')
getwd()

#upload feature table and metadata
md <- read.csv('07052023_metadata_pos.csv', header = T, check.names = F)
ft <- read.csv('06302023_pos_all_iimn_gnps_quant.csv', header = T, check.names = F, sep = ',')
...
write.csv(new_md, "/home/anastasiia/Desktop/proteus mirabilis/new_method_pos_2-99_ALL/Data_cleanup/md_new.csv",row.names = TRUE)
...
write.csv(Imp_clrt, "/home/anastasiia/Desktop/proteus mirabilis/new_method_pos_2-99_ALL/Data_cleanup/CLR_Scaled.csv",row.names = TRUE)
#manually
#clr <- function(m) {
