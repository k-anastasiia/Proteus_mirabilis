...
setwd('/home/anastasiia/Desktop/proteus mirabilis/new_method_neg/Multivariate')
getwd()

metadata<- read_csv("~/Desktop/proteus mirabilis/new_method_neg/Multivariate/06272023_metadata_neg.csv")
metadata <- metadata[-29:-30,] #exclude blank
scaled_table <- read_csv("~/Desktop/proteus mirabilis/new_method_neg/Multivariate/CLR_Scaled.csv")
...
metadata_d <- metadata_sorted [-14:-28,] #exclude blank
...
write.csv(pc_loadings_d, "pc_loadings_neg.csv",row.names = TRUE)
